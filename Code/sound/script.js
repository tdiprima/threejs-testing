...
let initCanvasAudio = name => {
  ...
  let volumeControl = audioCtx.createGain();
  ...
  // rAF and get the frequency data from the audio all the time so that we can
  // use it to update the amplitude
  function animate() {
  ...
  function render(freqData) {
    ...
    uniforms.amplitude.value = numscale(
      freqData[0],
      0,
      300,
      -2,
...
let numscale = (num, in_min, in_max, out_min, out_max) => {
