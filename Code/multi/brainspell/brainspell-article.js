...
function createEmptyNIDMTemplate(ArticlePMID) {
	...
	$("#doi").attr("href","https://web.archive.org/web/20160918095805/http://dx.doi.org/"+EmptyArticle.doi);
...
function downloadArticleXML(callback)
{
	...
	*/
	...
	$.get("https://web.archive.org/web/20160918095805/http://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi",
