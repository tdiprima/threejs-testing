...
/////////////////////////////////////////////////////////////////////////
///// RENDERER CONFIG
let renderer = new THREE.WebGLRenderer({ antialias: true }); // turn on antialias
...
/////////////////////////////////////////////////////////////////////////
///// SCENE LIGHTS
let ambient = new THREE.AmbientLight(0xa0a0fc, 0.82);
scene.add(ambient);

let sunLight = new THREE.DirectionalLight(0xe8c37b, 1.96);
...
let b = "military-base";
loader.load(`models/gltf/${b}.glb`, gltf => {
